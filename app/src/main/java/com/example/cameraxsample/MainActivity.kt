...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _binding.imageCaptureButton.setOnClickListener {
            takePhoto()
        }
    ...
    private fun takePhoto() {
        ...
        Log.d(TAG, "App started 1 $imageCapture")
        val imageCapture = imageCapture ?: return
        Log.d(TAG, "App started 1")
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            ...
            val preview = Preview.Builder()
                .build()
                .also {
                    it.surfaceProvider = _binding.viewFinder.surfaceProvider
                }
            //This line for camera or capture image only
            imageCapture = ImageCapture.Builder().build()
            //This code is for video capture
            ...
            try {
                ...
                Log.d(TAG, "Camera started succedd")
